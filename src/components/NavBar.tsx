  ...
  return (
    <>
      ...
      <div className="bg-[#15161D] py-3">
        <div className="max-width px-3 xl:px-0 flex flex-col md:flex-row items-center md:justify-between">
          <Image src={"/applogo.png"} alt="logo" width={170} height={70} />
          <InputWithButton
            ...
            buttonTitle="Search"
          />
          <div className="text-main-text">test</div>
        </div>
      </div>
    </>
  );
